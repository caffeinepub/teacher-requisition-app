...
export function Layout({
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      {/* Desktop sidebar */}
      <aside
        className="sidebar-gradient w-64 flex-shrink-0 flex-col hidden md:flex shadow-lg"
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <header className="bg-white border-b border-border flex items-center justify-between px-4 md:px-6 h-14 flex-shrink-0 shadow-xs">
